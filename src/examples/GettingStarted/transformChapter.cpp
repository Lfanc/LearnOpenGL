...
int main() {
    ...
    Shader shaderProgram = Shader("../assets/shaders/GettingStarted/transformChapter/vertexShader.glsl", "../assets/shaders/GettingStarted/transformChapter/fragmentShader.glsl");
    shaderProgram.use();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // uniform的位置值，将要发送多少个矩阵，是否希望对我们的矩阵进行转置(Transpose)，真正的矩阵数据
        ...
        // 缩放
        trans1 = glm::scale(trans1, glm::vec3(sin(glfwGetTime())));
        // 
