...
int main() {
    ...
    Shader lightingShader = Shader("../assets/shaders/Lighting/materialChapter/vertexShader.glsl", "../assets/shaders/Lighting/materialChapter/fragmentShader.glsl");
    Shader lightCubeShader = Shader("../assets/shaders/Lighting/materialChapter/vertexShader.glsl", "../assets/shaders/Lighting/materialChapter/lightfragmentShader.glsl");
