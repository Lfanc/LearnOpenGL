...
int main() {
    ...
    Shader lightingShader = Shader("../assets/shaders/Lighting/basicLightingChapter/vertexShader.glsl", "../assets/shaders/Lighting/basicLightingChapter/fragmentShader.glsl");
    Shader lightCubeShader = Shader("../assets/shaders/Lighting/basicLightingChapter/vertexShader.glsl", "../assets/shaders/Lighting/basicLightingChapter/lightfragmentShader.glsl");
