...
int main()
{
   ...
   // -------------------------
    Shader shader("../assets/shaders/AdvancedOpenGL/frameBuffers/sceneVS.glsl", "../assets/shaders/AdvancedOpenGL/frameBuffers/sceneFS.glsl");
    Shader screenShader("../assets/shaders/AdvancedOpenGL/frameBuffers/vs.glsl", "../assets/shaders/AdvancedOpenGL/frameBuffers/fs.glsl");
    ...
    */
    ...
    unsigned int floorTexture = loadTexture("../assets/images/awesomeface.png");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render
        // ------
        // 第一处理阶段(Pass)，偏航角旋转108°，绘制并保存到纹理附件上
        glBindFramebuffer(GL_FRAMEBUFFER, framebuffer);
        ...
        // 绘制窗口顶上的后视镜，使用第一次绘制并保存到纹理附件中的画面
