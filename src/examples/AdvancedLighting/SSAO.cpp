...
int main()
{
    ...
    Shader shaderGeometryPass("../assets/shaders/AdvancedLighting/SSAO/ssao_geometryVS.glsl", 
        "../assets/shaders/AdvancedLighting/SSAO/ssao_geometryFS.glsl");
    Shader shaderLightingPass("../assets/shaders/AdvancedLighting/SSAO/ssaoVS.glsl", 
        "../assets/shaders/AdvancedLighting/SSAO/ssao_lightingFS.glsl");
    Shader shaderSSAO("../assets/shaders/AdvancedLighting/SSAO/ssaoVS.glsl", 
        "../assets/shaders/AdvancedLighting/SSAO/ssaoFS.glsl");
    Shader shaderSSAOBlur("../assets/shaders/AdvancedLighting/SSAO/ssaoVS.glsl", 
        "../assets/shaders/AdvancedLighting/SSAO/ssao_blurFS.glsl");
    ...
    // Objects
    Model nanosuit("../assets/models/nanosuit_reflection/nanosuit.obj");
