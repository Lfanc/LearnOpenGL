...
int main()
{
    ...
    Shader shader("../assets/shaders/AdvancedLighting/NormalMapping/normal_mappingVS.glsl", 
        "../assets/shaders/AdvancedLighting/NormalMapping/normal_mappingFS.glsl");

    // Load textures
    GLuint diffuseMap = loadTexture("../assets/images/brickwall.jpg");
    GLuint normalMap = loadTexture("../assets/images/brickwall_normal.jpg");
