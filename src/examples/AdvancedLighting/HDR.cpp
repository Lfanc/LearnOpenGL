...
int main()
{
    ...
    Shader shader("../assets/shaders/AdvancedLighting/HDR/lightingVS.glsl", 
        "../assets/shaders/AdvancedLighting/HDR/lightingFS.glsl");
    Shader hdrShader("../assets/shaders/AdvancedLighting/HDR/hdrVS.glsl", 
        "../assets/shaders/AdvancedLighting/HDR/hdrFS.glsl");
    ...
    lightColors.push_back(glm::vec3(0.0f, 0.0f, 10.0f));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform1i(glGetUniformLocation(shader.ID, "woodTexture"), 0);
