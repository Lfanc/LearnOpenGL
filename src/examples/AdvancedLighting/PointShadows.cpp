...
int main()
{
    ...
    Shader shader("../assets/shaders/AdvancedLighting/PointShadows/point_shadowsVS.glsl", 
        "../assets/shaders/AdvancedLighting/PointShadows/point_shadowsFS.glsl");
    Shader simpleDepthShader("../assets/shaders/AdvancedLighting/PointShadows/point_shadows_depthVS.glsl",
        "../assets/shaders/AdvancedLighting/PointShadows/point_shadows_depthGS.glsl",
        "../assets/shaders/AdvancedLighting/PointShadows/point_shadows_depthFS.glsl");
    ...
    // Load textures
    woodTexture = loadTexture("../assets/images/wood.png");
