...
int main()
{
    ...
    // -------------------------
    Shader shader("../assets/shaders/AdvancedLighting/Blinn-Phong/VS.glsl", 
        "../assets/shaders/AdvancedLighting/Blinn-Phong/FS.glsl");
    ...
    // load textures
    // -------------
    unsigned int floorTexture = loadTexture("../assets/images/wood.png");
